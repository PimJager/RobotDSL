...
public class RobotGenerator {
  ...
  public static CharSequence toJava(final Robot root) {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("//local sensor values");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("static float frontUSSample;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("static float touchLeftSample;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("static float touchRightSample;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("static float colorSample;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("LCD.drawString(\"LeftL: \" + leftLightSamples[0], 0, 0);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("LCD.drawString(\"RightL: \" + rightLightSamples[0], 0, 1);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("LCD.drawString(\"RearUs: \" + rearUSSamples[0], 0, 2);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("LCD.drawString(\"Gyro: \" + gyroSamples[0], 0, 3);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("int tl = vals.touchLeft > 0.9 ? 1 : 0;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("int tr = vals.touchRight > 0.9 ? 1 : 0;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("LCD.drawString(\"Touch L:\"+tl+\" R:\"+tr, 0, 4);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("LCD.drawString(\"FrontUS: \" + vals.frontUS, 0, 5);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("LCD.drawString(\"color:\" + vals.color, 0, 6);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
