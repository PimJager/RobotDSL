...
public class RobotGenerator {
  ...
  public static CharSequence toJava(final Robot root) {
    ...
    _builder.newLine();
    _builder.append("import lejos.hardware.motor.EV3MediumRegulatedMotor;");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public static EV3MediumRegulatedMotor mesMotor \t= new EV3MediumRegulatedMotor(MotorPort.C); ");
    _builder.newLine();
    _builder.append("    ");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("rightLightSample = (int) (rightLightSamples[0] * 100);");
    _builder.newLine();
    _builder.append("    \t");
    ...
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("mesMotor.setSpeed(100);");
    _builder.newLine();
    _builder.append("    \t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("//measurement function");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public static void measure(){");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("mesMotor.backward();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("while(!mesMotor.isStalled()) {} //wait for arm to touch something");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("mesMotor.forward();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("while(!mesMotor.isStalled()) {} //wait for arm to go all the way back up");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("mesMotor.stop();");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private boolean beeped = false;");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
