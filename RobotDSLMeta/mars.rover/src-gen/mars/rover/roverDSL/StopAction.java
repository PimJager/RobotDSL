 ...
 * </p>
 * <ul>
 *   <li>{@link mars.rover.roverDSL.StopAction#getMotor <em>Motor</em>}</li>
 * </ul>
 *
 * @see mars.rover.roverDSL.RoverDSLPackage#getStopAction()
 * @model
 * @generated
 */
public interface StopAction extends Action
{
  /**
   ...
   * @see #setMotor(Motor)
   * @see mars.rover.roverDSL.RoverDSLPackage#getStopAction_Motor()
  ...
  /**
   * Sets the value of the '{@link mars.rover.roverDSL.StopAction#getMotor <em>Motor</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
